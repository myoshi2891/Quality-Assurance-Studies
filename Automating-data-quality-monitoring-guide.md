...
「データが多すぎて、どのテーブルが壊れているか誰も気づけない」——多くのデータチームが抱えるこの悩みに、正面から答えるのが本ガイドで取り上げる書籍です。世界中の企業が1日に生み出すデータ量は2.5エクサバイト（2京5000兆バイト）に達するという2012年時点の推計が広く引用されていますが[^1]、その中のどれだけが「良品」なのかを人手だけで確かめるのはもはや不可能です。
