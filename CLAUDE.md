...
- `app/agile-testing-practical-guide/NavBar.tsx` — Agile Testing 実践ガイドページ固有スティッキーナビ（`'use client'`、`lib/useScrollSpy.ts` でアクティブリンク制御、`aria-current` 対応、読了プログレスバー、モバイルトグル対応）
