...
- **2025年2月2日〜2026年7月26日（改正前）**：第4条は、AIシステムの提供者・導入者に対し、従業員等について**「可能な限り、十分なレベルのAIリテラシーを確保する」措置**を講じることを求めていました。
- **2026年7月27日以降（改正後）**：Digital Omnibus on AI（Regulation (EU) 2026/1744）により第4条が全面的に改正され、提供者・導入者に求められるのは**AIリテラシーの育成を支援する措置**になりました。改正後の条文は、**個人ごとに特定のAIリテラシー水準を保証することまでは求めない**と明記しています（結果の義務から努力の義務への変更）。
...
| 問 | 正解 | 解説 |
|:---:|:---:|---|
| 1 | **D** | DはシャドーAIの3リスク（セキュリティ・プライバシー／コンプライアンス／IP）に含まれない。A・B・Cが3リスクに対応。 |
...
| Digital Omnibus on AI（Regulation (EU) 2026/1744）公式条文 | <https://eur-lex.europa.eu/eli/reg/2026/1744/oj> | 第4条（AIリテラシー）の改正（2026年7月27日施行） |
