...
| 同値分割と境界値分析を使い分けられる | 専門的能力 | テスト技法のスキル |
| 前例のない新機能に対してテストアプローチを自分で組み立てられる | 方法論的能力 | 分析力・概念力・判断力 |
...
| メンバー | ドメイン知識（専門） | テスト技法（専門） | 自動化（方法論） | 交渉・調整（社会） | 自己管理（個人） |
|----------|----------------------|------------------------|--------------------|--------------------|--------------------|
| A さん | 3 | 2 | 1 | 2 | 3 |
| B さん | 1 | 3 | 3 | 1 | 2 |
| C さん | 2 | 2 | 0 | 3 | 2 |
...
| テーマ | 覚え方 |
|--------|--------|
| 4つの能力領域 | 「知識と技法（専門）・自力で考え抜く力（方法論）・人づきあい（社会）・自分の律し方（個人）」 |
