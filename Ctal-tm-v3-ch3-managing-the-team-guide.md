...
> 試験対策として使う前に、日本語版シラバス（JSTQB 版 **Version 3.0.J04**：最新版）の第3章と突き合わせてください。本ガイドが示す p.65〜73 は Version 3.0.J02 の目次に基づくページ範囲のため、J04 では改訂に伴いずれている可能性があります。Version 3.0.J01 は旧版で、差分確認用として参照してください。URL は「9. 出典」にあります。
...
| 資料 | URL | 用途 |
|------|-----|------|
| JSTQB：Advanced Level シラバス日本語版 テストマネジメント Version 3.0.J04（主参照・最新版） | <https://www.jstqb.jp/wordpress/wp-content/uploads/2026/06/JSTQB-Syllabus.Advanced_TM_VersionV3.0.J04.pdf> | 第3章の日本語訳の確認（ページ番号は J04 で要確認） |
| JSTQB：Advanced Level シラバス日本語版 テストマネジメント Version 3.0.J02 | <https://jstqb.jp/dl/JSTQB-Syllabus.Advanced_TM_VersionV3.0.J02.pdf> | 旧版（差分確認用）。本ガイドの p.65〜73 はこの版の目次に基づく |
