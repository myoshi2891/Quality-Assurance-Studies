...
9. [Canon TDD ― Kent Beckによる規範的な手順の再定義](#canon-tdd--kent-beckによる規範的な手順の再定義)
...
## Canon TDD ― Kent Beckによる規範的な手順の再定義

2023年12月、Kent Beckは自身のニュースレターで「Canon TDD（規範的TDD）」と題した記事を公開しました。これは、本書刊行から20年以上が経ち、TDDに対する誤解や自己流の“TDDもどき”批判が増えてきたことを受け、**本書で定義した本来のTDDの手順を、あらためて簡潔に明文化し直したもの**です。
...
初学者は、まず本書の実例でこのサイクルを体得したうえで、このCanon TDD記事を読むと、遠回りせずに「本来のTDDの姿」を確認できます。
