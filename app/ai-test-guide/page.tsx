                ...
                <section className="hero" id="top">
                    <div className="hero-content">
                        <span className="hero-eyebrow">
                            ISTQB CT-AI &amp; CT-GenAI 完全ガイド 2025
                        </span>
                        <h1>
                            AIシステムの
                            <br />
                        ...
                        <div className="ai-vs-box">
                            ...
                            <div className="ai-vs-card ai-based">
                                ...
                                <div className="tag-line">
                                    ...
                                    ◉ データ品質がモデル品質に直結
                                    <br />
                                    ◉ コンセプトドリフト・バイアスへの継続監視
                                    <br />◉ 幻覚・公平性・説明可能性のテストが必須
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="callout callout-info">
                            ...
                            <a
                                ...
                                target="_blank"
                            >
                                responsibleailabs.ai — LLM Evaluation Benchmarks 2025
                            </a>
                        </div>
                    </div>
                </section>
                ...
                <section id="intro">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 01 — CT-AI Chapter 1: INTRODUCTION TO AI
                        </span>
                        <h2>AIの基礎とテストへの影響</h2>
                    ...
                    <div className="card-grid">
                        <div className="card border-[#60a5fa]/25">
                            ...
                            <p>
                                特定タスクのみ遂行。現在の全商用AIが該当。画像認識・音声認識・チャットボット・推薦システム。
                                <strong className="text-[#63b3ed]">
                                    テスト対象：現時点のほぼ全て。
                                </strong>
                            </p>
                        </div>
                    ...
                    <div className="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>不具合の原因</strong>
                                    </td>
                                    <td>コードのバグ</td>
                                    <td className="r">
                                        データ品質・モデルアーキテクチャ・学習プロセス
                                    </td>
                                    <td>コードレビューだけでは不十分</td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>システムの進化</strong>
                                    </td>
                                    <td>明示的な更新のみ</td>
                    ...
                    <p className="text-sm mt-1">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            Microsoft — Testing Modern AI Systems (2025)
                        </a>
                    </p>
                </section>
...
══════════════════════════════════════  */}
                <section id="ml-overview">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 02 — CT-AI Chapter 3: MACHINE LEARNING OVERVIEW
                        </span>
...
テスト観点: 報酬ハッキング・意図しない副作用`}</pre>
                    ...
                    <div className="step-list">
                        <div className="step-item">
                            ...
                            <div className="step-content">
                                <h4>問題定義 &amp; データ収集</h4>
                                <p>
                                    解くべきビジネス課題の明確化。データソースの特定と収集。
                                    <strong className="text-[#f6e05e]">テスト観点：</strong>
                        ...
                        <div className="step-item">
                            ...
                            <div className="step-content">
                                <h4>データ準備 &amp; 前処理</h4>
                                <p>
                                    欠損値処理・正規化・特徴量エンジニアリング。訓練/検証/テストデータセットの分割（典型的に60/20/20）。
                                    <strong className="text-[#f6e05e]">テスト観点：</strong>
                        ...
                        <div className="step-item">
                            ...
                            <div className="step-content">
                                <h4>モデル訓練 &amp; 選択</h4>
                                <p>
                                    アルゴリズムの選定・ハイパーパラメータ調整。過学習・未学習の監視。
                                    <strong className="text-[#f6e05e]">テスト観点：</strong>
                        ...
                        <div className="step-item">
                            ...
                            <div className="step-content">
                                <h4>モデル評価</h4>
                                <p>
                                    テストセット（未使用データ）での最終評価。混同行列・各種メトリクスの計算。
                                    <strong className="text-[#f6e05e]">テスト観点：</strong>
                    ...
                    <div className="callout callout-warn mt-2">
                        <strong>過学習（Overfitting）vs 未学習（Underfitting）</strong>
                        <br />
                        過学習：訓練データに過度に適合し、未知データで性能が低下。バイアスが低く分散が高い状態。
                        <br />
                        未学習：訓練データでも性能が低い。モデルの複雑さが不足している状態。
                        <br />
...
══════════════════════════════════════  */}
                <section id="ml-metrics">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 03 — CT-AI Chapter 5: ML FUNCTIONAL PERFORMANCE METRICS
                        </span>
                    ...
                    <div className="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <strong>精度（Accuracy）</strong>
                                    </td>
                                    <td className="font-mono text-[11px]">(TP+TN) / 全件</td>
                                    <td>
                                        全予測中の正解率。クラスバランスが取れている場合に有効。
                                    </td>
                                    <td>一般的な分類タスク</td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>適合率（Precision）</strong>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>再現率（Recall / Sensitivity）</strong>
                                    </td>
                    ...
                    <div className="callout callout-info mt-2">
                        <strong>コンテキストによってどの指標を重視するかが変わる：</strong>
                        <br />
                        がんスクリーニング → <strong>再現率</strong>を最大化（見逃しを最小化）
                        <br />
                        迷惑メールフィルタ →<strong>適合率</strong>
                        を最大化（重要なメールをスパム扱いしない）
                        <br />
                        クレジットカード不正検知 →<strong>F1スコア</strong>（両方のバランスが必要）
                        <br />
                        参照:
                        <a
                            href="https://istqb.org/certifications/certified-tester-ai-testing-ct-ai/"
                            ...
                            target="_blank"
                        >
                            ISTQB CT-AI Syllabus Section 5
                        </a>
                    </div>
...
══════════════════════════════════════  */}
                <section id="ai-quality">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 04 — CT-AI Chapter 2: QUALITY CHARACTERISTICS FOR AI SYSTEMS
                        </span>
                        <h2>AIシステム固有の品質特性</h2>
                        <div className="accent-line"></div>
                        <p>
                    ...
                    <div className="card-grid">
                        <div className="card border-[#8b5cf6]/30">
                            ...
                            <p>
                                新しいデータ・環境変化・未知の入力に適応できるか。硬直したルールベースシステムとの決定的な違い。
                                <br />
                                <strong className="text-[#b794f4]">テスト：</strong>
                                分散シフトテスト・ドメイン適応評価。
                            </p>
                        </div>
                        <div className="card border-[#22d3ee]/25">
                            ...
                            <h3>自律性（Autonomy）</h3>
                            <p>
                                人間の介入なしにタスクを遂行できるか。自律性のレベルが高いほどテストの難易度と重要性が増大。
                                <br />
                                <strong className="text-[#4fd1c5]">テスト：</strong>
                        ...
                        <div className="card border-[#fbbf24]/20">
                            ...
                            <h3>バイアス（Bias）</h3>
                            <p>
                                アルゴリズム・サンプル・不適切バイアスが特定グループに対する不公平な差別的出力を生む。
                                <br />
                                <strong className="text-[#f6e05e]">テスト：</strong>
                                公平性指標測定・差別的影響分析。
                            </p>
                        </div>
                        <div className="card border-[#4ade80]/20">
                            ...
                            <h3>透明性・解釈性・説明可能性</h3>
                            <p>
                                AI判断の根拠を人間が理解できるか。EU AI Act等の規制でも要求。
                                <br />
                                <strong className="text-[#68d391]">テスト：</strong>
                        ...
                        <div className="card border-[#f87171]/25">
                            ...
                            <p>
                                ...
                                failureの防止。
                                <br />
                                <strong className="text-[#fc8181]">テスト：</strong>
                        ...
                        <div className="card border-[#f97316]/20">
                            ...
                            <h3>進化（Evolution）</h3>
                            <p>
                                自己学習・継続学習により時間とともに動作が変化。デプロイ後のモデル劣化（コンセプトドリフト）への対処が必要。
                                <br />
                                <strong className="text-[#f6ad55]">テスト：</strong>
                                定期的再評価・ドリフト検出パイプライン。
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid-2">
                        <div>
                            <div className="callout callout-warn">
                                <strong>コンセプトドリフトとは？</strong>
                                <br />
                                本番データの統計的分布が訓練時と乖離していく現象。
                                モデルは「古いデータで正しい判断」をするが、
                                「現在のデータでは間違った判断」をするようになる。
                                <br />
                            ...
                            <div className="code-block mt-1">
                                <div className="code-header">
                                    ...
                                    <span className="code-lang">
                                        PYTHON — コンセプトドリフト検出（PSIスコア）
                                    </span>
                                </div>
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="kw">import</span> numpy <span class="kw">as</span> np
...
══════════════════════════════════════  */}
                <section id="test-techniques">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 05 — CT-AI Chapter 9: METHODS AND TECHNIQUES FOR AI TESTING
                        </span>
                    ...
                    <div className="card-grid">
                        <div className="card border-[#8b5cf6]/30">
                            ...
                            <p>
                                「入力を変換した時に出力がどう変わるべきか」という
                                <strong className="text-[#b794f4]">
                                    メタモルフィック関係（MR）
                                </strong>
                            ...
                            <div className="code-block mt-2">
                                ...
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="cm"># MR1: 同義語置換 → 感情スコアは不変</span>
...
期待: <span class="fn">sign</span>(入力1) ≠ <span class="fn">sign</span>(入力2)  <span class="cm"># MR維持</span>`,
                        ...
                        <div className="card border-[#f87171]/25">
                            ...
                            <div className="code-block mt-2">
                                ...
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="cm"># 元の文章 → 正常に分類</span>
...
- エラー率・遅延のトレードオフ評価`}</pre>
                        ...
                        <div className="card border-[#22d3ee]/20">
                            ...
                            <div className="code-block mt-2">
                                ...
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="cm"># 1. ラベルフリッピング攻撃</span>
正常: スパムメール → ラベル=spam
      ...
      → 特定の誤分類を誘発`,
                    ...
                    <p className="text-sm mt-2">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            Ministry of Testing — Metamorphic & Adversarial Strategies for AI
                        </a>
                        <a
                            ...
                            target="_blank"
                        >
                            Google — Adversarial Testing for Generative AI (2025)
                        </a>
                    </p>
                </section>
...
══════════════════════════════════════  */}
                <section id="hallucination">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 06 — CT-AI Chapter 8 / CT-GenAI Chapter 3: HALLUCINATION &amp; BIAS
                        </span>
                    ...
                    <p className="text-sm">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            factored.ai — Evaluating LLM Hallucinations
                        </a>
                        <a
                            ...
                            target="_blank"
                        >
                            testfort.com — AI Hallucination Testing Guide (Sep 2025)
                        </a>
                    </p>
                    ...
                    <div className="grid-2 mt-3">
                        <div>
                            ...
                            <div className="step-list">
                                <div className="step-item">
                                    <div className="step-num-circle bg-[#f87171]/10 border-[#f87171]/30 text-accent-red">
                                        I
                                    </div>
                                    <div className="step-content">
                                ...
                                <div className="step-item">
                                    <div className="step-num-circle bg-[#fbbf24]/10 border-[#fbbf24]/30 text-accent-yellow">
                                        E
                                    </div>
                                    <div className="step-content">
                                ...
                                <div className="step-item">
                                    <div className="step-num-circle bg-[#f97316]/10 border-[#f97316]/30 text-accent-orange">
                                        P
                                    </div>
                                    <div className="step-content">
                                        <h4>プロンプト誘発型幻覚</h4>
                        ...
                        <div>
                            ...
                            <div className="callout callout-danger">
                                <strong>Layer 1: 自動化テスト（スケール）</strong>
                                <br />
                                ゴールドセット比較（検証済み正解との自動比較）
                                <br />
                                LLM-as-a-Judge（別モデルが出力の事実性を評価）
                                <br />
                                TruthfulQA・HallucinationEval ベンチマーク実行
                            </div>
                            <div className="callout callout-warn">
                                <strong>Layer 2: 特化ツール（精度）</strong>
                                <br />
                                RAGAS（RAGシステムの幻覚検出）
                                <br />
                                DeepEval・Patronus AI（ファクトチェック自動化）
                                <br />
                                RefChecker・Hallucination Guard（引用検証）
                            </div>
                            <div className="callout callout-good">
                                <strong>Layer 3: 人間レビュー（信頼性）</strong>
                                <br />
                                専門家による出力の手動確認
                                <br />
                                エラー分析・ミティゲーション改善
                    ...
                    <p className="text-sm mt-1">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            Frontiers in AI — Hallucination Survey (2025)
                        </a>
                        <a
                            ...
                            target="_blank"
                        >
                            Deepchecks — Hallucination Detection (2025)
                        </a>
                    </p>
                </section>
...
══════════════════════════════════════  */}
                <section id="genai-testing">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 07 — CT-GenAI Chapter 1: INTRODUCTION TO GENAI FOR SOFTWARE TESTING
                        </span>
                    ...
                    <div className="callout callout-info">
                        <strong>CT-GenAI の2つの軸</strong>
                        <br />
                        <strong className="text-[#4fd1c5]">① Testing WITH GenAI</strong> —
                        LLMを活用してテストケース自動生成・欠陥予測・回帰テスト最適化を行う（AIがテストツールになる）
                        <br />
                        <strong className="text-[#b794f4]">② Testing OF GenAI</strong> —
                        LLM・生成AIシステム自体の品質（幻覚・バイアス・セキュリティ・プライバシー）をテストする（AIがテスト対象になる）
                        <br />
                        参照:
                        <a
                            ...
                            target="_blank"
                        >
                            ISTQB CT-GenAI Syllabus v1.0 (2025)
                        </a>
                    </div>
                    ...
                    <div className="card-grid">
                        <div className="card">
                            ...
                            <div className="code-block mt-2">
                                ...
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="prompt-role prompt-system">SYSTEM:</span> あなたはシニアQAエンジニアです。
                    ...
                    <div className="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <strong>忠実性（Faithfulness）</strong>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>事実正確性（Factual Accuracy）</strong>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>ロバスト性（Robustness）</strong>
                                    </td>
...
══════════════════════════════════════  */}
                <section id="prompt-eng">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 08 — CT-GenAI Chapter 2: PROMPT ENGINEERING FOR SOFTWARE TESTING
                        </span>
                        <h2>テストのためのプロンプトエンジニアリング</h2>
                        <div className="accent-line bg-accent-green"></div>
                        <p>
                            効果的なプロンプト設計はGenAIテストの品質を左右する核心スキル。CT-GenAI
                            v1.0 の重点章です。
                        </p>
                    </div>
                    ...
                    <div className="step-list">
                        <div className="step-item">
                            <div className="step-num-circle bg-[#4ade80]/10 border-[#4ade80]/30 text-accent-green">
                                1
                            </div>
                            <div className="step-content">
                    ...
                    <div className="card-grid">
                        ...
                        <div className="card">
                            ...
                            <div className="prompt-example mt-2">
                                <div className="prompt-role prompt-user">
                                    USER: 以下の関数のリスクを
                                    <span className="prompt-good">ステップバイステップで分析</span>
                                    し、 優先度付きテストケースを生成して。
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid-2">
                        <div>
                            <div className="callout callout-danger">
                                <strong>プロンプトインジェクション攻撃とは？</strong>
                                <br />
                            ...
                            <div className="code-block mt-2">
                                ...
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="cm">-- 正常なシステムプロンプト --</span>
...
の内容は...」 ← テストで検出すべき`,
                        ...
                        <div>
                            ...
                            <div className="step-list">
                                <div className="step-item py-[0.7rem]">
                                    <div className="step-num-circle w-[22px] h-[22px] text-[10px]">
                                        ✓
                                    </div>
                                    <div className="step-content">
                    ...
                    <p className="text-sm mt-2">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            EvidentlyAI — RAG Evaluation Guide
                        </a>
                        <a
                            ...
                            target="_blank"
                        >
                            Patronus AI — RAG Security Testing
                        </a>
                    </p>
                </section>
...
══════════════════════════════════════  */}
                <section id="rag-testing">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 09 — CT-GenAI Chapter 4: LLM-POWERED SOLUTIONS &amp; RAG TESTING
                        </span>
                        <h2>RAGシステムのテスト</h2>
...
最終回答         ← テスト: 回答の完全性・正確性・有害性なし`}</pre>
                    ...
                    <div className="code-block mt-3">
                        ...
                        <pre
                            dangerouslySetInnerHTML={{
                                __html: `<span class="kw">from</span> ragas <span class="kw">import</span> evaluate
...
# context_recall:   0.78  ← 78%の情報を検索できた（改善余地）</span>`,
                    ...
                    <p className="text-sm mt-1">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            Confident AI — Top LLM Eval Tools 2025
                        </a>
                    </p>
                </section>
...
══════════════════════════════════════  */}
                <section id="security">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 10 — CT-GenAI Chapter 3: MANAGING RISKS OF GENAI IN TESTING
                        </span>
                ...
                <section id="tools">
                    ...
                    <p className="text-sm mt-2">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            GitHub — Promptfoo (AI Red Teaming)
                        </a>
                        <a
                            ...
                            target="_blank"
                        >
                            ZenML — Best LLM Evaluation Tools 2025
                        </a>
                        <a
                            ...
                            target="_blank"
                        >
                            Braintrust — Top Prompt Evaluation Tools 2025
                        </a>
                    </p>
                </section>
...
══════════════════════════════════════  */}
                <section id="certifications">
                    <div className="section-header">
                        <span className="section-num">
                            STEP 12 — ISTQB AI CERTIFICATION ROADMAP
                        </span>
                    ...
                    <div className="cert-row">
                        <div className="cert-dot-col">
                            <div className="cert-dot bg-accent-purple shadow-[0_0_10px_rgba(139,92,246,0.5)]"></div>
                    ...
                    <div className="cert-row">
                        <div className="cert-dot-col">
                            <div className="cert-dot bg-accent-cyan shadow-[0_0_10px_rgba(34,211,238,0.5)]"></div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <span className="badge badge-int">前提</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <span className="badge badge-int">ML基礎</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <span className="badge badge-func">CT-AI準備</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <span className="badge badge-unit">GenAI実践</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <span className="badge badge-unit">CT-GenAI受験</span>
                                    </td>
...
══════════════════════════════════════  */}
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://www.allaboutai.com/resources/llm-hallucination/
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>テスト技法</td>
                                    <td>
                                        Ministry of Testing — Metamorphic & Adversarial Strategies
                                        for AI
                                    </td>
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://www.ministryoftesting.com/articles/metamorphic-and-adversarial-strategies-for-testing-ai-systems
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>テスト技法</td>
                                    <td>
                                        Google — Adversarial Testing for Generative AI (Aug 2025)
                                    </td>
                                    <td>
                                        <a
                                            href="https://developers.google.com/machine-learning/guides/adv-testing"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://arxiv.org/pdf/2310.06800
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://www.techrxiv.org/users/927947/articles/1304989
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://aisingapore.github.io/handbook-staging/book/6-modelling/ml-risks-and-robustness.html
                                        </a>
                                    </td>
                                </tr>
                                <tr>
            ...
            <footer>
                <p>
                    ...
                    &nbsp;&amp;&nbsp;
                    <a href="https://istqb.org/certifications/gen-ai/" target="_blank">
                        CT-GenAI v1.0
                    </a>
                    準拠
                </p>
