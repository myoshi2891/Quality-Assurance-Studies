                ...
                <div className="compare-grid">
                    ...
                    <div className="compare-box good">
                        ...
                        <div className="code-block" data-lang="TDD PATTERN">
                            <pre dangerouslySetInnerHTML={{ __html: "<span class=\"code-comment\"># ✅ Step 1: RED — 失敗するテストを書く</span>\n<span class=\"code-keyword\">import</span> <span class=\"code-white\">pytest</span>\n<span class=\"code-keyword\">from</span> <span class=\"code-white\">calculator</span> <span class=\"code-keyword\">import</span> <span class=\"code-white\">Calculator</span>\n\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">test_add_two_positive_numbers</span>():\n    <span class=\"code-white\">calc = Calculator()  </span><span class=\"code-comment\"># まだ存在しない！</span>\n    <span class=\"code-keyword\">assert</span> <span class=\"code-white\">calc.add(3, 5) == 8</span>\n\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">test_divide_by_zero_raises</span>():\n    <span class=\"code-white\">calc = Calculator()</span>\n    <span class=\"code-keyword\">with</span> <span class=\"code-white\">pytest.raises(ValueError):</span>\n        <span class=\"code-white\">calc.divide(10, 0)</span>" }} />
                        </div>
                    </div>
                </div>
        ...
        <section id="ch2-bdd">
            <div className="container">
                ...
                <div className="code-block" data-lang="PYTHON — PYTEST-BDD">
                    <pre dangerouslySetInnerHTML={{ __html: "<span class=\"code-comment\"># step_definitions/cart_steps.py</span>\n<span class=\"code-keyword\">from</span> <span class=\"code-white\">pytest_bdd</span> <span class=\"code-keyword\">import</span> <span class=\"code-white\">given, when, then, parsers</span>\n\n<span class=\"code-cyan\">@given(</span><span class=\"code-string\">\"カートが空である\"</span><span class=\"code-cyan\">)</span>\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">empty_cart</span>(<span class=\"code-white\">cart_context</span>):\n    <span class=\"code-white\">cart_context.cart = CartService.create_empty_cart()</span>\n\n<span class=\"code-cyan\">@when(</span><span class=\"code-white\">parsers.parse(</span><span class=\"code-string\">'ユーザーが \"{product_name}\" を{quantity:d}台カートに追加する'</span><span class=\"code-white\">)</span><span class=\"code-cyan\">)</span>\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">add_to_cart</span>(<span class=\"code-white\">cart_context, product_name: str, quantity: int</span>):\n    <span class=\"code-white\">product = ProductService.find_by_name(product_name)</span>\n    <span class=\"code-white\">cart_context.response = CartService.add_item(</span>\n        <span class=\"code-white\">cart_id=cart_context.cart.id,</span>\n        <span class=\"code-white\">product_id=product.id,</span>\n        <span class=\"code-white\">quantity=quantity</span>\n    <span class=\"code-white\">)</span>\n\n<span class=\"code-cyan\">@then(</span><span class=\"code-white\">parsers.parse(</span><span class=\"code-string\">\"カートに{count:d}件の商品がある\"</span><span class=\"code-white\">)</span><span class=\"code-cyan\">)</span>\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">verify_cart_count</span>(<span class=\"code-white\">cart_context, count: int</span>):\n    <span class=\"code-white\">cart = CartService.get_cart(cart_context.cart.id)</span>\n    <span class=\"code-keyword\">assert</span> <span class=\"code-white\">len(cart.items) == count</span>" }} />
                </div>
            </div>
        </section>
            ...
            <div className="container">
                ...
                <div className="compare-grid">
                    <div className="compare-box bad">
                        ...
                        <div className="code-block" data-lang="ANTI-PATTERN">
                            <pre dangerouslySetInnerHTML={{ __html: "<span class=\"code-keyword\">def</span> <span class=\"code-red\">test1</span>():\n    <span class=\"code-white\">d = webdriver.Chrome()</span>\n    <span class=\"code-white\">d.get(</span><span class=\"code-string\">\"https://example.com/login\"</span><span class=\"code-white\">)</span>\n    <span class=\"code-white\">d.find_element(</span><span class=\"code-string\">\"id\"</span><span class=\"code-white\">, </span><span class=\"code-string\">\"email\"</span><span class=\"code-white\">).send_keys(</span>\n      <span class=\"code-string\">\"test@example.com\"</span><span class=\"code-white\">)</span>\n    <span class=\"code-white\">time.sleep(3)  </span><span class=\"code-red\"># ← 固定sleep！</span>\n    <span class=\"code-keyword\">assert</span> <span class=\"code-string\">\"Dashboard\"</span> <span class=\"code-keyword\">in</span> <span class=\"code-white\">d.title</span>\n    <span class=\"code-white\">d.quit()</span>\n\n<span class=\"code-keyword\">def</span> <span class=\"code-red\">test2</span>():\n    <span class=\"code-white\">d = webdriver.Chrome()</span>\n    <span class=\"code-red\"># ← 重複セットアップ！</span>\n    <span class=\"code-white\">time.sleep(3)  </span><span class=\"code-red\"># ← 固定sleep！</span>\n    <span class=\"code-keyword\">assert</span> <span class=\"code-string\">\"Admin\"</span> <span class=\"code-keyword\">in</span> <span class=\"code-white\">d.title</span>\n    <span class=\"code-white\">d.quit()</span>" }} />
                        </div>
                    </div>
                    <div className="compare-box good">
                        <div className="compare-header">✅ リファクタリング後</div>
                        <div className="code-block" data-lang="BEST PRACTICE">
                            <pre dangerouslySetInnerHTML={{ __html: "<span class=\"code-cyan\">@pytest.fixture</span>\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">driver</span>():\n    <span class=\"code-white\">d = webdriver.Chrome()</span>\n    <span class=\"code-keyword\">yield</span> <span class=\"code-white\">d</span>\n    <span class=\"code-white\">d.quit()  </span><span class=\"code-comment\"># 確実なクリーンアップ</span>\n\n<span class=\"code-keyword\">class</span> <span class=\"code-cyan\">LoginPage</span>:\n    <span class=\"code-keyword\">def</span> <span class=\"code-green\">login</span>(<span class=\"code-white\">self, email, password</span>):\n        <span class=\"code-comment\"># 条件ベース待機（固定sleep排除）</span>\n        <span class=\"code-white\">WebDriverWait(self._driver, 10).until(</span>\n            <span class=\"code-white\">EC.url_changes(</span>\n              <span class=\"code-string\">\"https://example.com/login\"</span><span class=\"code-white\">)</span>\n        <span class=\"code-white\">)</span>\n\n<span class=\"code-comment\"># 命名規則: test_[対象]_[条件]_[期待動作]</span>\n<span class=\"code-keyword\">def</span> <span class=\"code-green\">test_user_login_redirect_to_dashboard</span>(\n  <span class=\"code-white\">login_page</span>):\n    <span class=\"code-white\">login_page.login(</span><span class=\"code-string\">\"test@example.com\"</span><span class=\"code-white\">, </span><span class=\"code-string\">\"pass\"</span><span class=\"code-white\">)</span>\n    <span class=\"code-keyword\">assert</span> <span class=\"code-string\">\"dashboard\"</span> <span class=\"code-keyword\">in</span> <span class=\"code-white\">login_page._driver.current_url</span>" }} />
                        </div>
                    </div>
                </div>
