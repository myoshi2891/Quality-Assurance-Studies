...
/**
 * Render the complete ISTQB CTFL-AT (Certified Tester Foundation Level Agile Tester) study guide page.
 *
 * The component returns a static, single-page JSX layout including a Header and a main container with
 * the full guide content: table of contents, chapters (overview, agile development, agile testing,
 * techniques and tools), exam tips, sample questions with answers, references, and disclaimers.
 *
 * @returns A JSX element containing the full CTFL-AT guide page (Header plus main content).
 */
