/**
 * Renders the "現代ソフトウェアテスト完全ガイド 2025" guide as a single-page, sectioned document.
 *
 * このガイドはかつてルート `/` に置かれていたが、`/` を全ガイドの index 画面へ
 * 置き換えたのに伴い、`foundation`（基礎テスト手法）カテゴリの 1 ページとして
 * このルートへ移設した。
 *
 * @returns The JSX element for the guide layout, including the main content sections (top, overview, step1–step4, methodologies, BDD, nonfunctional, security, accessibility, ISTQB, references) and footer.
 */
export default function ModernSoftwareTestingGuide() {
    return (
        <>
            <main>
                <section
                ...
                >
                    <div className="hero-content animate-[fade-up_0.7s_ease_forwards]">
                        ...
                        <p className="hero-sub text-[1.05rem] text-text-secondary max-w-[680px] leading-[1.9] mb-10">
                        ...
                        <div className="hero-stats flex flex-wrap gap-6 mb-12">
                            <div className="stat flex flex-col py-4 px-6 bg-bg-card border border-border rounded-sm">
                        ...
                        <div className="callout callout-info border-l-[3px] py-4 px-5 rounded-r-sm my-4 mt-6 text-[13.5px] leading-[1.75] border-accent-blue bg-accent-blue/5">
                            <strong>シフトレフト × シフトライト</strong>
                            &nbsp;—
                            2025年の業界標準は、要件定義段階からテストを組み込む「シフトレフト」と、
                            本番環境での継続的監視を行う「シフトライト」を
                            <strong>融合させたアプローチ</strong>です。
...
════════════════════════════════════════  */}
                <section id="overview">
                    <div className="section-header mb-8">
                        <span className="section-num font-mono text-[11px] font-bold text-accent-cyan tracking-[0.2em] block mb-2">
                            SECTION 00 — TEST STRATEGY
                        </span>
                        <h2>テスト戦略の「形状」を理解する</h2>
                        <div className="accent-line w-[48px] h-[3px] rounded-[2px] bg-accent-cyan my-4"></div>
                        <p>
                    ...
                    <div className="table-wrapper overflow-x-auto my-6">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <strong>テストピラミッド</strong>
                                        <br />
                                        <span className="badge badge-unit inline-block py-[3px] px-[10px] rounded-[20px] text-[11px] font-semibold font-mono tracking-[0.05em] bg-accent-cyan/12 text-unit border border-accent-cyan/30">
                                            Test Pyramid
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>テストトロフィー</strong>
                                        <br />
                                        <span className="badge badge-int inline-block py-[3px] px-[10px] rounded-[20px] text-[11px] font-semibold font-mono tracking-[0.05em] bg-accent-blue/12 text-integration border border-accent-blue/30">
                                            Test Trophy
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>テストハニカム</strong>
                                        <br />
                                        <span className="badge badge-func inline-block py-[3px] px-[10px] rounded-[20px] text-[11px] font-semibold font-mono tracking-[0.05em] bg-accent-purple/12 text-functional border border-accent-purple/30">
                                            Test Honeycomb
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>テストダイヤモンド</strong>
                                        <br />
                                        <span className="badge badge-e2e inline-block py-[3px] px-[10px] rounded-[20px] text-[11px] font-semibold font-mono tracking-[0.05em] bg-accent-orange/12 text-e2e border border-accent-orange/30">
                                            Test Diamond
                                        </span>
                                    </td>
                                    <td>過渡期のアーキテクチャ</td>
                                ...
                                <tr>
                                    <td>
                                        <strong>アイスクリームコーン</strong>
                                        <br />
                                        <span className="badge badge-sec inline-block py-[3px] px-[10px] rounded-[20px] text-[11px] font-semibold font-mono tracking-[0.05em] bg-accent-red/12 text-accent-red border border-accent-red/30">
                                            Anti-Pattern
                                        </span>
                                    </td>
                                    <td>🚫 アンチパターン（避けるべき）</td>
...
════════════════════════════════════════  */}
                <section id="step1">
                    ...
                    {/*  Why Unit Tests  */}
                    <div className="callout callout-info border-l-[3px] py-4 px-5 rounded-r-sm my-4 text-[13.5px] leading-[1.75] border-accent-blue bg-accent-blue/5">
                        <strong>なぜユニットテストが最重要か？</strong>　IBM研究によれば、
                        本番で発見したバグの修正コストはユニットテスト段階の<strong>約100倍</strong>
                    ...
                    <div className="card-grid">
                        <div className="card-sm">
                            <span className="first-letter-badge">F</span>ast
                            <p
                                style={{
                                    fontSize: '13px',
                        ...
                        <div className="card-sm">
                            <span className="first-letter-badge">I</span>solated
                            <p
                                style={{
                                    fontSize: '13px',
                                    color: 'var(--color-text-secondary)',
                        ...
                        <div className="card-sm">
                            <span className="first-letter-badge">R</span>epeatable
                            <p
                                style={{
                                    fontSize: '13px',
                                    color: 'var(--color-text-secondary)',
                        ...
                        <div className="card-sm">
                            <span className="first-letter-badge">S</span>elf-validating
                            <p
                                style={{
                                    fontSize: '13px',
                                    color: 'var(--color-text-secondary)',
                        ...
                        <div className="card-sm">
                            <span className="first-letter-badge">T</span>imely
                            <p
                                style={{
                                    fontSize: '13px',
                                    color: 'var(--color-text-secondary)',
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <div className="step-list flex flex-col gap-0">
                                <div className="step-item flex gap-5 py-5 border-b border-border last:border-b-0">
                                    <div className="step-num-circle shrink-0 w-8 h-8 rounded-full flex items-center justify-center font-mono text-[12px] font-bold bg-accent-cyan/10 border border-accent-cyan/30 text-accent-cyan mt-[2px]">
                                        A
                                    </div>
                        ...
                        <div>
                            <div className="code-block bg-[#080c18] border border-border rounded-sm overflow-hidden my-4">
                                <div className="code-header flex items-center justify-between py-2 px-[14px] bg-white/5 border-b border-border">
                                    <div className="code-dots flex gap-[5px]">
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                    </div>
                                    <span className="code-lang font-mono text-[11px] text-text-muted tracking-[0.1em]">
                                        PYTHON / pytest
                                    </span>
                                </div>
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="cm"># テスト対象 (src/calculator.py)</span>
    ...
    <span class="kw">def</span> <span class="fn">test_ゼロ除算は例外を発生</span>(<span class="dec">self</span>):
        <span class="kw">with</span> pytest.raises(<span class="cls">ValueError</span>,
            ...
            divide(<span class="num">10</span>, <span class="num">0</span>)`,
                    ...
                    {/*  Anti-patterns  */}
                    <div className="callout callout-danger border-l-[3px] py-4 px-5 rounded-r-sm my-4 mt-6 text-[13.5px] leading-[1.75] border-accent-red bg-accent-red/5">
                        <strong>⚠ 「実装の詳細」をテストすることの危険性</strong>
                        <br />
                        内部状態変数名・プライベートメソッドをテストすると、
                        リファクタリング時にアプリは正常でもテストが落ちる「偽陰性（False
                        Negative）」が頻発します。
                        さらに内部が破綻していてもテストが通る「偽陽性（False
                        Positive）」のリスクも生じます。
                        <strong>
                            ユーザーが観測できる振る舞い（アウトプット・副作用）だけをテストしてください。
                        </strong>
                        <br />
                        <a
                            rel="noopener noreferrer"
                    ...
                    <div className="tool-grid grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-3">
                        ...
                        <div className="tool-card bg-bg-card border border-border rounded-sm p-4 transition-all duration-200 cursor-default flex flex-col gap-[6px] hover:border-border-bright hover:bg-bg-card-hover hover:-translate-y-[1px]">
                            ...
                            <div className="tool-desc text-[12px] text-text-secondary leading-[1.6]">
                                AI駆動テスト管理。複数FWを一元管理・自動テスト生成・Flaky
                                test自動検出
                            </div>
                            <span className="badge badge-int inline-block py-[3px] px-[10px] rounded-[20px] text-[11px] font-semibold font-mono tracking-[0.05em] bg-accent-blue/12 text-integration border border-accent-blue/30">
                                AI-powered
...
════════════════════════════════════════  */}
                <section id="step2">
                    ...
                    <div className="card-grid grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4">
                        <div className="card bg-bg-card border border-border rounded-DEFAULT p-6 transition-all duration-250 hover:bg-bg-card-hover hover:border-border-bright hover:shadow-DEFAULT">
                            ...
                            <div className="code-block bg-[#080c18] border border-border rounded-sm overflow-hidden my-4 mt-4">
                                <div className="code-header flex items-center justify-between py-2 px-[14px] bg-white/5 border-b border-border">
                                    <div className="code-dots flex gap-[5px]">
                                        <span></span>
                                        <span></span>
                                ...
                                <pre
                                    dangerouslySetInnerHTML={{
                                        __html: `<span class="cm"># 有効クラス: 0 ≤ age ≤ 120</span>
...
════════════════════════════════════════  */}
                <section id="step3">
                    ...
                    <div className="code-block bg-[#080c18] border border-border rounded-sm overflow-hidden my-4 mt-8">
                        <div className="code-header flex items-center justify-between py-2 px-[14px] bg-white/5 border-b border-border">
                            <div className="code-dots flex gap-[5px]">
                                <span></span>
                                <span></span>
...
════════════════════════════════════════  */}
                <section id="step4">
                    ...
                    <div className="callout callout-good border-l-[3px] py-4 px-5 rounded-r-sm my-4 text-[13.5px] leading-[1.75] border-accent-green bg-accent-green/5">
                        <strong>2025年の結論：</strong>
                        Playwright
                        がエンタープライズ・CI/CDにおいて主流。大規模並列実行・クロスブラウザ安定性が決定的優位性。
                        Cypress はフロントエンド開発者のローカルデバッグで依然として最高のDX。
                        Selenium はモバイル自動化（Appium連携）とレガシー環境で不滅の存在感。
                    </div>
                    ...
                    <div className="table-wrapper overflow-x-auto my-6 mt-6">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>ブラウザ安定性</strong>
                                    </td>
                                    <td className="good">
                                        Chromium/Firefox/WebKit（平均失敗率2%）
                                    </td>
                                    <td className="warn">
                                        Chrome/Edgeに最適化（WebKitで9-15%失敗率）
                                    </td>
                                    <td className="warn">全ブラウザ対応・設定複雑</td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>デバッグ体験</strong>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <strong>推奨ユースケース</strong>
                                    </td>
                                    <td className="good">
                                        エンタープライズ・大規模CI/CD・クロスブラウザ
                                    </td>
                    ...
                    <div className="code-block bg-[#080c18] border border-border rounded-sm overflow-hidden my-4 mt-8">
                        ...
                        <pre
                            dangerouslySetInnerHTML={{
                                __html: `<span class="kw">import</span> { test, expect } <span class="kw">from</span> <span class="str">'@playwright/test'</span>;
                ...
                <section id="methodologies">
                    <div className="section-header mb-8">
                        ...
                        <p>
                            ...
                            現代のWebアプリ開発では、これらを
                            <strong>戦略的に組み合わせることが最適解</strong>です。
                        </p>
                    </div>
                    ...
                    <div className="callout callout-good mt-3">
                        ...
                        バランスよく組み合わせた組織は、本番デプロイ前にクリティカルな欠陥を
...
════════════════════════════════════════  */}
                <section id="bdd">
                    ...
                    <div className="gherkin bg-[#0a0f1e] border border-border rounded-sm py-5 px-6 font-mono text-[13px] leading-[1.8]">
                        ...
                        ユーザーが登録済みメールアドレス
                        <span className="param">"user@example.com"</span> を持っている
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<span className="kw-when">When</span>
                        ログインフォームに正しいパスワード
                        <span className="param">"Password123!"</span> を入力する
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<span className="kw-then">Then</span>
                        ダッシュボードページに遷移する
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<span className="kw-then">And</span> 歓迎メッセージ
                        <span className="param">"ようこそ、田中さん"</span> が表示される
                        <br />
                        <br />
                        &nbsp;&nbsp;<span className="kw-scen">Scenario:</span>
                        誤ったパスワードでログイン失敗
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;<span className="kw-when">When</span>
                        ログインフォームに誤ったパスワード
                        <span className="param">"WrongPass"</span> を入力する
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<span className="kw-then">Then</span>{' '}
                        エラーメッセージ
                    ...
                    <div className="callout callout-warn mt-3">
                        <strong>「BDDは死んだのか？」2025年の議論</strong>
                        <br />
                        ...
                        導入コストを劇的に下げる試みが進行中です。組織文化に合わせた
...
════════════════════════════════════════  */}
                <section id="nonfunctional">
                    ...
                    <div className="metrics-grid grid grid-cols-[repeat(auto-fill,minmax(220px,1fr))] gap-3">
                        <div className="metric-card bg-bg-card border border-border rounded-sm p-4">
                            <span className="metric-tag font-mono text-[11px] text-accent-yellow block mb-[6px]">
                                Response Time
                            </span>
                            <div className="metric-title text-[12px] font-semibold text-text-secondary mb-1">
                                応答時間
                            </div>
                    ...
                    <div className="table-wrapper overflow-x-auto my-6">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>エンデュランステスト（Soak Testing）</strong>
                                    </td>
                    ...
                    <div className="tool-grid grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-3">
                        ...
                        <div className="tool-card bg-bg-card border border-border rounded-sm p-4 transition-all duration-200 cursor-default flex flex-col gap-[6px] hover:border-border-bright hover:bg-bg-card-hover hover:-translate-y-[1px]">
                            ...
                            <div className="tool-desc text-[12px] text-text-secondary leading-[1.6]">
                                Micro
                                Focus製エンタープライズ標準。数千の仮想ユーザーをシミュレート可能
                            </div>
                ...
                <section id="security">
                    <div className="section-header mb-8">
                        ...
                        <p>
                            ...
                            セキュリティテストは製品完成後の監査から
                            <strong>設計段階へ完全シフトレフト</strong>しています。
                        </p>
                    </div>

                    <div className="callout callout-danger border-l-[3px] py-4 px-5 rounded-r-sm my-4 text-[13.5px] leading-[1.75] border-accent-red bg-accent-red/5">
                        <strong>2025年の新重要課題：AIシステムのセキュリティテスト</strong>
                        <br />
                ...
                <section id="accessibility">
                    <div className="section-header mb-8">
                        ...
                        <p>
                            ...
                            <strong>全てのユーザーが利用できるシステムの構築</strong>
                            は必須要件です。
                        </p>
                    </div>

                    <div className="callout callout-warn border-l-[3px] py-4 px-5 rounded-r-sm my-4 text-[13.5px] leading-[1.75] border-accent-yellow bg-accent-yellow/5">
                        <strong>自動化ツールの限界を理解する：</strong>
                        自動ツールが検出できるのは全問題の約<strong>30〜40%</strong>
                        のみです（明らかなカラーコントラスト違反・空の見出し等）。
...
════════════════════════════════════════  */}
                <section id="istqb">
                    ...
                    {/*  CTFL  */}
                    <div className="cert-row flex gap-4 items-stretch py-6 border-b border-border last:border-b-0 max-md:flex-col">
                        <div className="cert-level-badge shrink-0 w-[60px] text-center flex flex-col items-center justify-start gap-[6px] pt-1 max-md:flex-row max-md:w-auto">
                            <div
                        ...
                        <div className="cert-level-badge shrink-0 w-[60px] text-center flex flex-col items-center justify-start gap-[6px] pt-1 max-md:flex-row max-md:w-auto">
                            <div
                                ...
                                style={{
                                    ...
                                    boxShadow: '0 0 8px rgba(183, 148, 244, 0.4)',
                                }}
                            ></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://istqb.org/certifications/certified-tester-mobile-application-testing-ct-mat/
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://premiersoft.net/en/blog/an-analysis-of-the-different-test-shapes
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://www.testmuai.com/blog/unit-testing-frameworks/
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://learning.postman.com/docs/tests-and-scripts/test-apis/test-apis
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://javascript.plainenglish.io/playwright-vs-cypress-performance-benchmarks-the-2025-report-c2db402c7a55
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://dev.to/matt_calder_e620d84cf0c14/black-box-vs-white-box-vs-grey-box-testing-a-practical-guide-i9d
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://monday.com/blog/rnd/behavior-driven-development/
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://medium.com/@priti_9991/performance-testing-metrics-that-matter-in-2025-fc4d4d7a68fe
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://solutionshub.epam.com/blog/post/types-of-performance-testing
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://medium.com/@abhishekpurohit444/modern-sdet-toolkit-performance-security-accessibility-chaos-testing-tools-explained-410298d045aa
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://www.mend.io/blog/security-testing-in-2025-testing-apps-ai-cloud-native-and-more/
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://dev.to/maria_bueno/2025-guide-best-10-accessibility-testing-tools-automated-41
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://blog.qasource.com/shift-left-testing-a-beginners-guide-to-advancing-automation-with-generative-ai
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://trendig.com/en/blog/software-testing-trends-2025/
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            target="_blank"
                                        >
                                            https://buzzclan.com/quality-assurance/black-box-testing/
                                        </a>
                                    </td>
                                </tr>
                            </tbody>
