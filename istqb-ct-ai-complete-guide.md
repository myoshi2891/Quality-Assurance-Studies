...
flowchart TD
    ...
    subgraph Specialist ["スペシャリスト資格"]
        GenAI["CT-GenAI（Generative AI Testing）<br/>生成AI・LLMを使ったテストとLLMのテスト<br/>※2025年リリース"]
        AI["CT-AI（Certified Tester AI Testing）<br/>AIベースシステムのテスト ＆ テストへのAI活用<br/>※本資格！"]
    end
...
> ✓ エルボー法（Elbow Method）
> ✓ ダビエス-ボールディン指標（Davies–Bouldin Index）
...
### 9.2 バック・ツー・バックテスト（Back-to-Back Testing）
...
他の選択肢：
- 88.9%：誤答。本ケースの 適合率（Precision）= TP/(TP+FP) = 80/(80+20) = 80/100 = 80%
