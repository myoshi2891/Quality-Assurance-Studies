...
1. [CTAL-ATT 概要と資格ロードマップ](#%F0%9F%8C%9F-chapter-0-ctal-att-%E6%A6%82%E8%A6%81%E3%81%A8%E8%B3%87%E6%A0%BC%E3%83%AD%E3%83%BC%E3%83%89%E3%83%9E%E3%83%83%E3%83%97)
2. [Chapter 1: 要件エンジニアリング（Requirements Engineering）](#%F0%9F%93%8B-chapter-1-%E8%A6%81%E4%BB%B6%E3%82%A8%E3%83%B3%E3%82%B8%E3%83%8B%E3%82%A2%E3%83%AA%E3%83%B3%E3%82%B0%EF%BC%88requirements-engineering%EF%BC%89)
   - [1.1.1 ユーザーストーリーとエピックの分析](#section-1-1)
   - [1.1.2 受入基準の特定](#section-1-2)
3. [Chapter 2: アジャイルにおけるテスト（Testing in Agile）](#%F0%9F%94%84-chapter-2-%E3%82%A2%E3%82%B8%E3%83%A3%E3%82%A4%E3%83%AB%E3%81%AB%E3%81%8A%E3%81%91%E3%82%8B%E3%83%86%E3%82%B9%E3%83%88%EF%BC%88testing-in-agile%EF%BC%89)
...
4. [Chapter 3: テスト自動化（Test Automation）](#%E2%9A%99%EF%B8%8F-chapter-3-%E3%83%86%E3%82%B9%E3%83%88%E8%87%AA%E5%8B%95%E5%8C%96%EF%BC%88test-automation%EF%BC%89)
   - [3.1 テスト自動化技法](#section-3-1)
   - [3.2 自動化レベルの最適化](#section-3-2)
5. [Chapter 4: デプロイメントとデリバリー（Deployment and Delivery）](#%F0%9F%94%84-chapter-4-%E3%83%87%E3%83%97%E3%83%AD%E3%82%A4%E3%83%A1%E3%83%B3%E3%83%88%E3%81%A8%E3%83%87%E3%83%AA%E3%83%90%E3%83%AA%E3%83%BC%EF%BC%88deployment-and-delivery%EF%BC%89)
   - [4.1 CI/CT/CD](#section-4-1)
   - [4.2 サービス仮想化](#section-4-2)
6. [試験対策・サンプル問題](#%F0%9F%93%9D-%E8%A9%A6%E9%A8%93%E5%AF%BE%E7%AD%96%E3%83%BB%E3%82%B5%E3%83%B3%E3%83%97%E3%83%AB%E5%95%8F%E9%A1%8C)
...
> flowchart BT
>     CTFL_v4["CTFL v4.0"]
>     CTFL_old["旧CTFL + CTFL-AT"]
>     CTAL_ATT["CTAL-ATT<br>（Advanced Level Agile Technical Tester）<br>← 本資格!"]
>
>     CTFL_v4 -->|前提条件| CTAL_ATT
>     CTFL_old -->|前提条件| CTAL_ATT
> ```
>
...
| **合格点** | 42点（64点満点） |
| **合格率目標** | 約65% |
| **試験時間** | 90分（英語非母語者: 113分） |
| **前提条件** | CTFL v4.0 または 旧CTFL + CTFL-AT |
| **推奨経験** | 18ヶ月以上の実務 |
| **学習時間** | 最低960分(16時間) |
...
```mermaid
pie title 学習時間配分 (合計 960分)
    "Chapter 1: 要件エンジニアリング" : 90
    "Chapter 2: アジャイルにおけるテスト" : 360
    "Chapter 3: テスト自動化" : 270
    "Chapter 4: デプロイメントとデリバリー" : 240
```
...
> ```mermaid
> flowchart BT
>     Unit["ユニット<br>← 多い（速い・コスト低）"]
>     Integration["統合"]
>     E2E["E2E<br>← 少ない（遅い・コスト高）"]
>
>     Unit --- Integration
>     Integration --- E2E
> ```
...
> ```mermaid
> flowchart TD
>     Red["RED 🔴<br>失敗するテストを書く（まだコードがない）"]
>     Green["GREEN 🟢<br>テストが通るコードを最小限書く（クリーンでなくてよい、動けばOK）"]
>     Refactor["REFACTOR 🔵<br>コードをきれいに整理する（テストが引き続き通ることを確認しながら）"]
>
>     Red --> Green
>     Green --> Refactor
>     Refactor -.->|"次の機能へ"| Red
...
>
> | | チーム支援（Guiding Development） | 製品評価（Critique Product） |
> | :--- | :--- | :--- |
> | **ビジネス<br>（Business Facing）** | **Q2**<br>受入テスト<br>BDD シナリオ<br>プロトタイプ | **Q3**<br>探索的テスト<br>ユーザビリティテスト<br>性能テスト |
> | **技術<br>（Technology Facing）** | **Q1**<br>ユニットテスト<br>コンポーネントテスト<br>TDD | **Q4**<br>技術的テスト<br>性能テスト<br>静的分析 |
...
>    ```mermaid
>    flowchart TD
>        E2E["E2E テスト<br>← 多すぎる（遅い・不安定）"]
>        Integration["統合テスト"]
>        Unit["ユニットテスト<br>← 少なすぎる"]
>
>        E2E --- Integration
>        Integration --- Unit
>    ```
...
>     Build --> Test["Test"]
>     Test --> Ready["🟢 Ready to Deploy"]
>
>     Ready -->|Continuous Delivery| CD_Human["Human Approval"]
>     CD_Human --> CD_Deploy["Deploy to Production"]
>
>     Ready -->|Continuous Deployment| CD_Auto["Automated Deploy"]
>     CD_Auto --> CD_Prod["Production"]
>   ```
>
