...
```
╔══════════════════════════════════════════════════════════════════════╗
║              ISTQB® 認定資格ロードマップ（2025年版）                    ║
╠══════════════════════════════════════════════════════════════════════╣
║                                                                      ║
║  [EXPERT LEVEL] ← ★ あなたはここ！★                                 ║
║   ┌──────────────────────────────────────────────────────────────┐  ║
║   │  CTEL-TM（Expert Level Test Management）                      │  ║
║   │  ┌─────────────────┬──────────────────┬──────────────────┐  │  ║
║   │  │ Part 1 (SM)     │ Part 2 (OTM)     │ Part 3 (MTT)     │  │  ║
║   │  │ Strategic Test  │ Operational Test │ Managing the     │  │  ║
║   │  │ Management      │ Management       │ Test Team        │  │  ║
║   │  │ ← 本ガイド      │                  │                  │  │  ║
║   │  └─────────────────┴──────────────────┴──────────────────┘  │  ║
...
║   [ADVANCED LEVEL]                                                   ║
║   ┌──────────────────────────────────────────────────────────────┐  ║
║   │  CTAL-TM v3.0（Advanced Level Test Management）               │  ║
║   └──────────────────────────────────────────────────────────────┘  ║
║          ↑ 前提資格                                                   ║
║   [FOUNDATION LEVEL]                                                 ║
║   ┌──────────────────────────────────────────────────────────────┐  ║
...
║         パート      │     焦点領域              │  試験            ║
╠═══════════════════════════════════════════════════════════════════╣
║  Part 1: SM (SM)   │ ミッション・政策・戦略・    │ 14問/45分        ║
║  Strategic Test    │ ライフサイクル考慮          │ 合格: 23/35点    ║
║  Management        │ 外部関係・組織内ツール統合  │ ← 本ガイド対象   ║
╠═══════════════════════════════════════════════════════════════════╣
║  Part 2: OTM       │ 第三者関係・契約・          │ 個別試験         ║
║  Operational Test  │ プロジェクトリスク管理       │                 ║
║  Management        │ 回顧ミーティング            │                 ║
╠═══════════════════════════════════════════════════════════════════╣
║  Part 3: MTT       │ 採用・目標設定・            │ 個別試験         ║
║  Managing the      │ チームビルディング・         │                 ║
║  Test Team         │ 分散チームの管理            │                 ║
╚═══════════════════════════════════════════════════════════════════╝
```
...
```
╔══════════════════════════════════════════════════════════╗
║       CTEL-TM-SM Part 1 試験スペック（2025年）             ║
╠══════════════════════════════════════════════════════════╣
...
```
Chapter 1: テストミッション・ポリシー・戦略・目標   ████████████  ~30%
Chapter 2: 外部関係の管理                         ████████      ~20%
Chapter 3: 組織全体の管理                         ████████      ~20%
Chapter 4: ドメイン・プロジェクト要因               ████████      ~20%
Chapter 5: 有効性・効率性・満足度の評価             █████         ~10%
                                                 合計: ~100%
```
